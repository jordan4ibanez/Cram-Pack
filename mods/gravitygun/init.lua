...
minetest.register_node("gravitygun:gun3_placeable", {
	description = "Gravitygun overloaded (placeable)",
	tiles = {"default_cloud.png","default_bronze_block.png","default_steel_block.png^[colorize:#dddddd55","default_steel_block.png^[colorize:#333333aa","default_diamond_block.png","default_steel_block.png^[colorize:#111111cc"},
	groups = {dig_immediate = 3,not_in_creative_inventory=1},
	paramtype = "light",
	paramtype2="facedir",
	sunlight_propagates = true,
	drawtype="mesh",
	mesh="gravitygun_gun_placeable.obj",
	selection_box = {type = "fixed",fixed = { -0.3, -0.5, -0.2, 0.3, 0, 0.2}},
	drop="gravitygun:gun3",
})

minetest.register_node("gravitygun:gun2_placeable", {
	description = "Gravitygun (placeable)",
	tiles = {"default_cloud.png","default_bronze_block.png","default_steel_block.png^[colorize:#dddddd55","default_steel_block.png^[colorize:#333333aa","default_lava.png^[colorize:#aaaa00aa","default_steel_block.png^[colorize:#111111cc"},
	groups = {dig_immediate = 3,not_in_creative_inventory=1},
	paramtype = "light",
	paramtype2="facedir",
	sunlight_propagates = true,
	...
	mesh="gravitygun_gun_placeable.obj",
	selection_box = {type = "fixed",fixed = { -0.3, -0.5, -0.2, 0.3, 0, 0.2}},
	drop="gravitygun:gun2",
})

minetest.register_node("gravitygun:gun1_placeable", {
	description = "Gravitygun (placeable)",
	tiles = {"default_cloud.png","default_bronze_block.png","default_steel_block.png^[colorize:#dddddd55","default_steel_block.png^[colorize:#333333aa","default_lava.png^^[colorize:#ff440088","default_steel_block.png^[colorize:#111111cc"},
	groups = {dig_immediate = 3,not_in_creative_inventory=1},
	paramtype = "light",
	paramtype2="facedir",
	sunlight_propagates = true,
...
minetest.register_node("gravitygun:gun3", {
	...
	tiles = {"default_cloud.png","default_cloud.png","default_steel_block.png^[colorize:#dddddd55","default_steel_block.png^[colorize:#333333aa","default_diamond_block.png","default_steel_block.png^[colorize:#111111cc","default_copper_block.png"},
