dofile(minetest.get_modpath("hook_extras") .. "/bot.lua")
pchest={}


minetest.register_craft({
	output = "hook_extras:pchest",
	recipe = {
...
minetest.register_tool("hook_extras:pchest", {
	...
	inventory_image = "hook_extras_chest3.png",
		on_place = function(itemstack, user, pointed_thing)
			...
			minetest.set_node(pointed_thing.above, {name = "hook_extras:pchest_node",param1="",param2=p})
...
minetest.register_node("hook_extras:pchest_node", {
	description = "Portable locked chest",
...
allow_metadata_inventory_put = function(pos, listname, index, stack, player)
		...
		if (stack:get_name()~="hook_extras:pchest") and (owner==player:get_player_name() or owner=="") then
...
on_punch = function(pos, node, player, pointed_thing)
		...
		if meta:get_string("owner")==player:get_player_name() then
			...
			inv:add_item("trans", ItemStack("hook_extras:pchest"))
